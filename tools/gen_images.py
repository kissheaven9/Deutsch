...
JOBS = {
 ...
 # ---- картинки для карточек-частей ----
 'otto-part-1': (['otto-main.png'],
   "Раннее утро в уютном доме. Тот же рыжебородый Отто с референса (шляпа, клетчатый килт, связка "
   "ключей) только что встал, пьёт кофе, смотрит в календарь и держит телефон — собирается позвать "
   "гостей в сад. Тёплый утренний свет, сочные цвета. "+STYLE),
 'otto-part-2': (['otto-main.png'],
   "Отто с референса дома готовится к празднику: говорит по старому телефону, вокруг сумки с "
   "покупками, на столе продукты. Оживлённо, ярко. "+STYLE),
 'otto-part-3': (['otto-main.png'],
   "Солнечный вокзал. Отто с референса с чемоданчиком садится в поезд; пустое табло (без текста), "
   "поезд, светлый зал. Динамично, насыщенные цвета. "+STYLE),
 'otto-part-4': (['otto-main.png','teo-main.png'],
   "Сад Отто днём. Отто с референса собирает длинный стол и убирает сад, знакомится с соседскими "
   "детьми — Тео (рыжий кудрявый, зелёно-полосатая кофта) и Лина (каштановые кудри, повязка, платье "
   "в цветочек) с кроликом. Зелень, цветы, яркое солнце. "+STYLE),
 'otto-part-5': (['otto-main.png'],
   "Тёплый вечер. Отто с референса гуляет по саду с чашкой кофе и машет соседям на прощание, у "
   "крыльца гирлянда фонариков. Закатные, но насыщенные краски. "+STYLE),
 'greta-part-1': (['greta-main.png'],
   "Грета с референса (тёмные кудри, круглые очки, красный берет, цветастая блузка, белый фартук) на "
   "яркой кухне получает из театра список гостей, радостно удивлена. Красные помидоры, жёлтые "
   "лимоны, солнечно. "+STYLE),
 'greta-part-2': (['greta-main.png'],
   "Грета с референса держит старую книгу итальянских рецептов из Неаполя, тёплая и задумчивая; "
   "вокруг специи и овощи, в окне солнечная Италия и море. Сочные цвета. "+STYLE),
 'greta-part-3': (['greta-main.png'],
   "Грета с референса радостно обнимает подругу Джулию (итальянка, короткие тёмные волосы); за "
   "чашкой чая обсуждают план, на столе торт и миска супа. Тепло, ярко. "+STYLE),
 'greta-part-4': (['greta-main.png'],
   "Грета с референса учит маленькую Лину (каштановые кудри, повязка, платье в цветочек) готовить на "
   "яркой кухне; овощи, большая миска, смех. Сочные краски. "+STYLE),
 'greta-part-5': (['greta-main.png'],
   "Яркий рынок. Грета с референса выбирает продукты, продавец протягивает ей спелые красные "
   "помидоры и жёлтые лимоны; корзины, солнце, много цвета. "+STYLE),
 'greta-part-6': (['greta-main.png'],
   "Кухня Греты. Грета с референса варит большую кастрюлю красного овощного супа, рядом маленькая "
   "Лина; пар, яркие овощи, тёплый свет, сочные цвета. "+STYLE),
 'greta-part-7': (['greta-main.png'],
   "Вечер премьеры. Нарядная Грета с референса счастлива у стола с блюдами, гости аплодируют, тёплые "
   "огни; она улыбается. Празднично, ярко, насыщенно. "+STYLE),
}
