...
async def main():
    ...
    for w in T20W:
        await tts(w, 'female', os.path.join(AUDIO,'word', slug(w)+'.mp3'))
    T20=[
      ('thema20-1','male','Früher war Otto Gärtner. Alle dachten: Otto ist sparsam und geizig. Aber das stimmt nicht! Otto hatte eine tolle Idee: eine eigene App und ein eigenes Start-up! Jeden Morgen ist Otto früh aufgestanden und hat gearbeitet. In der Nacht hat er an der App gearbeitet. Manchmal hat er sogar das Essen vergessen! Sein ganzes Geld war für das Projekt: ein Computer, die Technik und eine Website. Otto hat viele Fehler gemacht. Oft hat die App nicht funktioniert. Ein Start-up gründen ist nicht einfach, hat er gedacht. Aber Otto hat die App immer wieder verbessert und ausprobiert. Endlich hat alles funktioniert! Heute hat Otto ein Start-up: SUPS. SUPS berät und hilft anderen Start-ups. Otto ist jetzt erfolgreich und sehr zufrieden. Er erzählt oft: Ich war nicht geizig — ich hatte nur eine große Idee!'),
