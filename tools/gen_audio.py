...
async def main():
    ...
    VERBS=['wohnen','leben','lernen','machen','arbeiten','studieren','planen','glauben',
           ...
           'aufmachen','vorbereiten','einstellen','schneiden','anfangen','zusammenarbeiten','leiten','helfen','einladen','gefallen','verkaufen','erzählen','bekommen','bezahlen','verdienen','planen','suchen','aufräumen','zählen','aufstehen','verpassen','vergessen','anschauen','verlieren','verbessern','verwalten','beraten','transportieren','organisieren','gründen','erfinden','ausprobieren','funktionieren','anrufen','kennen','aussehen','helfen','denken','mitarbeiten']
    for inf in VERBS:
    ...
    T20W=['Start-up','Service','Fehler','Website','Projekt','Technik','Idee','Werbung','Kommunikation','Medien','Spezialist','Berater','Experte','Psychologin','U-Bahn','Päckchen','Szene','Bart','Locke','Kollege','Vorstellungsgespräch','Stelle','Pause','Team','Kunde','erfolgreich','zufrieden','sparsam','geizig','sympathisch','nett','freundlich','kreativ','fröhlich','ruhig','schlank','kräftig','langweilig','unfreundlich']
    for w in T20W:
        await tts(w, 'female', os.path.join(AUDIO,'word', slug(w)+'.mp3'))
    T20=[
      ('thema20-1','male','Kennt ihr Otto? Früher war Otto Gärtner. Alle dachten: Otto ist sehr sparsam, fast geizig — er kauft nur billige Sachen. Aber das stimmt nicht! Otto war nicht geizig. Er hatte einen großen Traum: eine eigene App und ein eigenes Start-up. Jeden Abend ist Otto nach Hause gekommen. Er ist fast nie ausgegangen — er hatte keine Zeit. In der Nacht hat er an seiner App gearbeitet, oft bis drei Uhr morgens. Sein ganzes Geld hat er in das Projekt investiert: einen Computer, Technik, eine Website. Deshalb hat er so sparsam gelebt — nicht aus Geiz, sondern für seinen Traum! Otto hat viele Fehler gemacht, und manchmal hat die App nicht funktioniert. Ein Start-up zu gründen ist nicht einfach, hat er gedacht. Aber Otto hat nicht aufgegeben. Er hat die App immer wieder verbessert und ausprobiert. Endlich hat alles funktioniert! Heute hat Otto sein eigenes Start-up — es heißt SUPS. SUPS berät und hilft anderen Start-ups. Otto ist jetzt erfolgreich und sehr zufrieden. Ich war nie geizig, lacht er. Ich habe nur an meinen Traum geglaubt!'),
      ('thema20-2','female','Otto arbeitet nicht allein. Sein Team bei SUPS ist klein, aber super! Wie sehen die Leute aus, und was machen sie? Greta macht die Werbung und das Marketing. Sie ist Spezialistin für Kommunikation und Medien. Greta ist klein, hat lange dunkle Locken und sieht sehr sympathisch aus. Sie ist kreativ, freundlich und immer fröhlich. Eine gute Idee braucht gute Werbung, sagt sie. Ben ist der IT-Berater und Experte für Technik. Er ist groß und kräftig, hat einen Bart und kurze Haare. Ben ist ruhig — er spricht nicht viel, aber er kennt jeden Computer. Probleme mit der Technik? Ruft mich an! Tamy ist Psychologin. Sie organisiert die Arbeit und verbessert den Workflow. Tamy ist schlank, jung und sehr nett. Sie hat schon in mehreren Firmen mitgearbeitet. Das ganze Team sieht sympathisch aus und arbeitet gut zusammen. Niemand ist langweilig oder unfreundlich. Meine Kollegen und Kolleginnen sind die besten, sagt Otto stolz.'),
      ('thema20-3','male','Stefan möchte bei SUPS arbeiten. Heute hatte er ein wichtiges Vorstellungsgespräch. Aber was für ein Tag! Am Morgen ist Stefan zu spät aufgestanden. Er ist schnell zur U-Bahn gelaufen, aber er hat die U-Bahn verpasst! Puh, hat er gedacht. Im Bus hat er dann auch noch sein Handy verloren. Echt? So ein Pech! Endlich ist Stefan bei SUPS angekommen. Otto hat ihn freundlich beraten und ihm alles über die Firma erzählt. Stefan hat das Team kennengelernt — alle waren nett und sympathisch. Die moderne Website und das Büro haben ihm sehr gefallen. Nach einer kurzen Pause hat Stefan eine gute Nachricht bekommen: Er hat die Stelle bei SUPS! Otto hat ihn später angerufen: Willkommen im Team! Stefan war sehr zufrieden. Am Abend hat Stefan noch ein Päckchen zum Kunden transportiert. Dann hat er seiner Freundin Melissa alles erzählt: Ich habe die U-Bahn verpasst und mein Handy verloren — aber dann habe ich die Stelle bekommen! Was für ein Tag, hat Stefan gesagt — müde, aber glücklich.'),
    ]
