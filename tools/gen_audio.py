...
async def main():
    ...
    for w in T20W:
        await tts(w, 'female', os.path.join(AUDIO,'word', slug(w)+'.mp3'))
    T20=[
      ('thema20-1','male','Otto hat eine tolle Idee: Er erfindet eine Garten-App! Die App ist für Menschen mit Garten. Viele Leute vergessen, ihre Blumen zu gießen. Die App hilft ihnen jeden Tag. So vergisst niemand mehr seine Pflanzen! Otto steht jeden Morgen früh auf. Er kauft im Supermarkt ein, holt seinen Computer ab und arbeitet. Am Anfang hat die App nicht gut ausgesehen, aber Otto hat sie immer wieder verbessert. Greta hat die App zuerst ausprobiert. Sie hat Otto besucht, und die App hat ihr sehr gefallen! Greta hat allen davon erzählt — ihren Freunden und Kollegen. So hat Otto die ersten zehn Kunden bekommen! Otto organisiert jetzt alles selbst. Er berät die Kunden, und Greta arbeitet bei ihm mit. Wenn ein Kunde anruft, ruft Otto schnell zurück. Manchmal transportiert er auch Pflanzen zu den Leuten. Ein Tag war schwer: Otto ist zu spät aufgestanden, hat den Bus verpasst und hat sein Handy verloren! Aber dann hat er neue Kunden kennengelernt und sie in den Garten eingeladen. Was für ein Tag, hat Otto erzählt — müde, aber glücklich.'),
      ('thema20-2','female','Otto arbeitet nicht allein. Wie sieht sein Team aus? Greta macht die Werbung und ist Spezialistin für Kommunikation und Medien. Sie ist klein und jung, hat lange Locken und sieht sympathisch aus. Greta ist kreativ, freundlich und lustig — nie langweilig! Ben ist Berater und Experte für Technik. Er ist groß und kräftig und hat einen Bart. Ben ist ruhig, aber nett und intelligent. Probleme mit dem Computer? Ruft mich an! Tamy ist Psychologin. Sie organisiert die Arbeit, leitet das Geld und verbessert alles. Tamy ist schlank, nicht alt und sehr interessant. Sie hat schon in vielen Firmen mitgearbeitet. Das Team sieht sympathisch aus, und alle arbeiten gut zusammen. Niemand ist unfreundlich oder unsympathisch. Meine Kollegen sind die besten, sagt Otto.'),
    ...
    T20.append(('thema20-reviews','female','Anna: Ich habe die App ausprobiert. Früher habe ich oft vergessen, meine Blumen zu gießen. Die App hat mir sehr gefallen! Ben: Mein Kollege hat mir die App erzählt. Ich habe Otto angerufen, und er hat schnell zurückgerufen. Super Service! Lina: Otto hat die App immer wieder verbessert. Ich habe ihn besucht und neue Leute kennengelernt. Er hat mich in den Garten eingeladen. Max: Heute bin ich zu spät aufgestanden und habe den Bus verpasst — aber die App hilft mir!'))
